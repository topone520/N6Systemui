...
import com.adayo.systemui.functional.seat._binder.CollapseViewBinder;
...
public class BackRowSeatDialogBindView extends BindViewBaseDialog {

    public BackRowSeatDialogBindView(@NonNull Context context, int dialogWidth, int _dialogHeight) {
    ...
    protected void createViewBinder() {
        ...
        insertViewBinder(new CollapseViewBinder());
    }

    @Override
    protected int acquireResourceId() {
        return R.layout.seat_back_row_layout;
    }
}
