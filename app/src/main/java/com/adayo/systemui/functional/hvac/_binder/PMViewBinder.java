...
import com.adayo.systemui.windows.views.hvac.PMView;
import com.android.systemui.R;

public class PMViewBinder extends AbstractViewBinder<Integer> {
    private static final String TAG = PMViewBinder.class.getSimpleName();
    private PMView _pm_view;
