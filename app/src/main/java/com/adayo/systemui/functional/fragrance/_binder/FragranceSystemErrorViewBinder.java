...
public class FragranceSystemErrorViewBinder extends AbstractViewBinder<Integer> {

    private static final String TAG = FragranceSystemErrorViewBinder.class.getSimpleName();
    private RelativeLayout fragSystemErrorView; //警告-香氛系统故障
    private final int _resource_id;

    public FragranceSystemErrorViewBinder(int resourceId) {
        //super(new ViewBinderProviderInteger(FragranceService.getInstance(), null, null, null, FragranceSOAConstant.));
