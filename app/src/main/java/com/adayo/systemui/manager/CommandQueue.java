...
import com.adayo.systemui.interfaces.CallbackController;
...
public class CommandQueue extends IStatusBar.Stub implements CallbackController<CommandQueue.Callbacks>,
    ...
    private static final int MSG_GESTURE_EVENT          = 57 << MSG_SHIFT;
    ...
    public interface Callbacks {
         ...
         *
         * @param displayId The id of the display to notify.
         * @param window Window type. It should be one of {@link StatusBarManager#}
         *               or {@link StatusBarManager#}
        ...
        default void onGestureEvent(int action,float x, float y){}
    }
...
//    }
    ...
    public void onGestureEvent(int action, float x, float y) {
        synchronized (mLock) {
            ...
            args.arg2 = y;
            args.argi1 = action;
            mHandler.obtainMessage(MSG_GESTURE_EVENT, args).sendToTarget();
        }
    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                case MSG_GESTURE_EVENT:
                    args = (SomeArgs) msg.obj;
                    int action = (int) args.argi1;
                    float x = (float) args.arg1;
                    float y = (float) args.arg2;
                    for (Callbacks callbacks: mCallbacks) {
                        callbacks.onGestureEvent( action,x,y);
                    }
                    break;
            }
        }
