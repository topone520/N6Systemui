...
@Entity(tableName = "FragranceSlotTable")
public class FragranceInfo {
    ...
    @Ignore
    public FragranceInfo(int position, int type, String title) {
    ...
    @Ignore
    public FragranceInfo(int position, int type, String title, int slide, int cover, int background, int write) {
        this.position = position;
        this.type = type;
        this.title = title;
        this.slide = slide;
