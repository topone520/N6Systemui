...
public class VtpFragranceMapUtils {
    private static final String TAG = VtpFragranceMapUtils.class.getSimpleName();
    public static HashMap<Integer, Integer> typeMap = null;

    public static VtpFragranceInfo makeFragranceInfo(int position, int type, String newTitle) {
        switch (type) {
            case FragranceSOAConstant.TYPE_ONE:
                return new VtpFragranceInfo(position, type,
                        ...
                        R.mipmap.vtp_ac_fragrance_bg_bule2,
            ...
            case FragranceSOAConstant.TYPE_TWO:
                return new VtpFragranceInfo(position, type,
                        ...
                        R.mipmap.vtp_ac_fragrance_bg_green,
            ...
            case FragranceSOAConstant.TYPE_THREE:
                return new VtpFragranceInfo(position, type,
                        ...
                        R.mipmap.vtp_ac_fragrance_bg_yellow,
            ...
            case FragranceSOAConstant.TYPE_NULL:
                return new VtpFragranceInfo(position, type,
                        ...
                        R.drawable.drawable_fragrance_default,
                        R.mipmap.vtp_ac_fragrance_bg_bule1,
                        R.layout.fragrance_slot_copywriting_4);
            default:
                return new VtpFragranceInfo();
        }
    }
