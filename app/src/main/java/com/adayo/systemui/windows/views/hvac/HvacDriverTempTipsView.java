 ...
 * @author ADAYO-13
 */
public class HvacDriverTempTipsView {
    private static String TAG = HvacDriverTempTipsView.class.getSimpleName();
    private volatile static HvacDriverTempTipsView _initial_view_bar;
    private WindowManager mWindowManager;
    private WindowManager.LayoutParams params;

    public static HvacDriverTempTipsView getInstance() {
        if (_initial_view_bar == null) {
            synchronized (HvacDriverTempTipsView.class) {
                if (_initial_view_bar == null) {
                    _initial_view_bar = new HvacDriverTempTipsView();
                }
            }
        }
    ...
    private HvacDriverTempTipsView() {
        // 获取 WindowManager 服务
        _init_bar();
    }
    ...
    private void _init_bar() {
        ...
        AAOP_HSkin.getWindowViewManager().addWindowView(mFloatingView);
