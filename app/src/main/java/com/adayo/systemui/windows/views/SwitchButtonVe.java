...
import com.adayo.systemui.utils.ColorUtils;
import com.android.systemui.R;
import com.android.systemui.SystemUIApplication;

/**
 * SwitchButton - 滑动动效 开关
 *
 * @since 2014-09-24
 */
@SuppressWarnings("unused")
public class SwitchButtonVe extends CompoundButton {
    private static final String TAG = "SwitchButtonVe";
    public static final float DEFAULT_THUMB_RANGE_RATIO = 1.8f;
    public static final int DEFAULT_THUMB_SIZE_DP = 20;
    public static final int DEFAULT_THUMB_MARGIN_DP = 2;
    public static final int DEFAULT_ANIMATION_DURATION = 250; //250
    ...
    public SwitchButtonVe(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public SwitchButtonVe(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public SwitchButtonVe(Context context) {
        super(context);
        init(null);
    }
    ...
    private void init(AttributeSet attrs) {
        ...
        mProgressAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator valueAnimator) {
                Log.i(TAG,"onAnimationUpdate valueAnimator.getAnimatedValue() = " + valueAnimator.getAnimatedValue());
        ...
        if (mTintColor == 0) {
            ...
            boolean found = getContext().getTheme().resolveAttribute(androidx.appcompat.R.attr.colorAccent, typedValue, true);
            if (found) {
        ...
        setThumbDrawable(SystemUIApplication.getSystemUIContext().getResources().getDrawable(R.drawable.btn_switch_click_false));
        setThumbSize(12, 32); //中间的圆Thumb 直径
        setThumbRangeRatio(6f); //开关宽度 是Thunm的几倍
        setThumbMargin(8,6,8,6);
        setBackDrawable(SystemUIApplication.getSystemUIContext().getResources().getDrawable(R.drawable.btn_switch_click_true_1));
    }
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (Math.abs(deltaX) < mTouchSlop && Math.abs(deltaY) < mTouchSlop && time < mClickTimeout) {
                    ...
                    Log.i(TAG,"MotionEvent.ACTION_UP nextStatus = " + nextStatus + " isChecked() = "
                            + isChecked());
...
//                    }
    ...
    protected void animateToState(boolean checked) {
        Log.i(TAG,"animateToState checked = " + checked + " mAnimationDuration = " + mAnimationDuration
                + " mProgress = " + mProgress);
        if (mProgressAnimator == null) {
            return;
        }
        Log.i(TAG,"animateToState mProgressAnimator.isRunning() = " + mProgressAnimator.isRunning());
        ...
        Log.i(TAG,"animateToState mProgressAnimator.start()");
    ...
    public void setChecked(final boolean checked) {
        Log.i(TAG,"setChecked isChecked() = " + isChecked() + " checked = " + checked + " mRestoring = " + mRestoring);
    ...
    public void setCheckedNoEvent(final boolean checked) {
        Log.i(TAG,"setCheckedNoEvent checked = " + checked);
    ...
    public void setCheckedImmediately(boolean checked) {
        super.setChecked(checked);
        Log.i(TAG,"setCheckedImmediately checked = " + checked);
        if (mProgressAnimator != null && mProgressAnimator.isRunning()) {
            Log.i(TAG,"setCheckedImmediately mProgressAnimator.cancel()");
            mProgressAnimator.cancel();
        }
