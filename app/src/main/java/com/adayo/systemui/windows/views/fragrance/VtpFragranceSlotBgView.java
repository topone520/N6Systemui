...
public class VtpFragranceSlotBgView extends FrameLayout {
    private static final String TAG = VtpFragranceSlotBgView.class.getSimpleName();

    private Context _context;
    private RelativeLayout fragSlotBg;
    private FrameLayout frameView;

    public VtpFragranceSlotBgView(@NonNull Context context) {
        super(context);
    }

    public VtpFragranceSlotBgView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        _context = context;
        initView();
    }

    public VtpFragranceSlotBgView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void initView() {
        addView(LayoutInflater.from(_context).inflate(R.layout.vtp_fragrance_slot_bg_view, null));
