 ...
 * @author Y4170
 */
public class QsSeekBar extends AppCompatSeekBar {
    /**
    ...
    public QsSeekBar(@NonNull Context context) {
        this(context,null);
    }

    public QsSeekBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public QsSeekBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr){
        super(context, attrs, defStyleAttr);
        mContext = context;
        setSplitTrack(false);
//        setThumb(ContextCompat.getDrawable(mContext, R.drawable.adayo_seekbar_thumb));
        setPadding(0, 0, 0, 0);
        setProgressDrawable(ContextCompat.getDrawable(mContext , R.drawable.qs_seekbar_background_1));
    ...
    public QsSeekBar setNeedTimePark(boolean need){
        needShowPopup = need;
        return this;
    }
    ...
    public QsSeekBar setPopupWindowType(int type){
