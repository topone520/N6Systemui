...
public class ScreenVolumeSeekBar extends AppCompatSeekBar {
    /**
    ...
    public ScreenVolumeSeekBar(@NonNull Context context) {
        this(context,null);
    }

    public ScreenVolumeSeekBar(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public ScreenVolumeSeekBar(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr){
        super(context, attrs, defStyleAttr);
        mContext = context;
        setSplitTrack(false);
//        setThumb(ContextCompat.getDrawable(mContext, R.drawable.adayo_seekbar_thumb));
        setPadding(0, 0, 0, 0);
        setProgressDrawable(ContextCompat.getDrawable(mContext , R.drawable.adayo_screen_volume_seekbar_bg));
    ...
    public ScreenVolumeSeekBar setNeedTimePark(boolean need){
        needShowPopup = need;
        return this;
    }
    ...
    public ScreenVolumeSeekBar setPopupWindowType(int type){
